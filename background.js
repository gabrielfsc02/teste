...
const w = {
  ...
  // Url do Agente IA
  agente_ia: "https://ia.wascript.com.br/produto/pacote-premium-2",
  // Limite de midia no Resposta Rapida
  midiaLimit: 50
};
async function b() {
  try {
...
chrome.alarms.onAlarm.addListener((e) => {
  switch (e.name) {
    // 1 Minuto
    case "One_Minute":
      n("https://web.whatsapp.com/*", "Update_Agendamento", {}), n("https://web.whatsapp.com/*", "Update_Status", {}), n("https://web.whatsapp.com/*", "Update_BackupAutomatico", {}), f();
      break;
    // 5 Minutos
    case "Five_Minutes":
...
const r = /* @__PURE__ */ new Map(), p = (e, t, o) => {
  ...
  try {
    chrome.tabs.onUpdated.removeListener(p), chrome.tabs.onRemoved.removeListener(u);
  } catch (e) {
    console.error("erro ao remover os ouvintes do WhatsIsOpen", e);
  } finally {
    chrome.tabs.onUpdated.addListener(p), chrome.tabs.onRemoved.addListener(u);
  }
};
c();
m();
